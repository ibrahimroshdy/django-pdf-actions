...
class ReshapeToArabicTest(TestCase):
    ...
    def test_landscape_reshape_to_arabic_long_text_wrapping(self, mock_create_style):
        ...
        long_text_obj = MockModel(
            id=1, 
            name='This is a very long name that should be wrapped because it exceeds the maximum characters per line limit',
        ...
        data = landscape_reshape_to_arabic(
            columns, 'Helvetica', 10, queryset, max_chars, self.settings, self.modeladmin
        )
