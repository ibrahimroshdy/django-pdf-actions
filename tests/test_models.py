...
from django_pdf_actions.models import (
    ExportPDFSettings, validate_hex_color, get_available_fonts, 
    ColorField, PAGE_SIZES, ALIGNMENT_CHOICES
)
...
class ExportPDFSettingsValidationTest(TestCase):
    ...
    def test_model_meta(self):
        ...
        self.assertEqual(ExportPDFSettings._meta.verbose_name_plural, 'Export PDF Settings')
    ...
    def test_valid_hex_colors(self):
        ...
        for color in valid_colors:
            try:
                ...
                self.fail(f"validate_hex_color raised ValidationError for valid color: {color}")
