...
from django.test import TestCase, TestSuite, TestLoader
...
class DjangoPDFActionsTestSuite(TestCase):
    ...
    def test_package_imports(self):
        ...
        try:
            from django_pdf_actions import models
            from django_pdf_actions import actions
            from django_pdf_actions import admin
            from django_pdf_actions import apps
            from django_pdf_actions.actions import portrait
            from django_pdf_actions.actions import landscape
            from django_pdf_actions.actions import utils
